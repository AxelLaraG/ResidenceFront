...
const Verification = ({title,message,accept,cancel,onAccept,onCancel,onClose}) => {
  return (
    <StyledWrapper>
      <div className="card"> 
        <button type="button" className="dismiss" onClick={onClose}>×</button> 
        <div className="header"> 
          ...
          <div className="actions">
            <button type="button" className="history" onClick={onAccept}>{accept}</button> 
            <button type="button" className="track" onClick={onCancel}>{cancel}</button> 
          </div> 
        </div> 
      </div>
    </StyledWrapper>
